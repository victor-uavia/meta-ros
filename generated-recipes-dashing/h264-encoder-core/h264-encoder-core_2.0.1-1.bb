...
SRC_URI = "https://github.com/aws-gbp/h264_encoder_core-release/archive/release/dashing/h264_encoder_core/2.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b7052b455dde55e5c1967e8cdb50f280"
SRC_URI[sha256sum] = "2a39d34702af1080f41f54517d9ea611a75cc18104a73f05eb33db3ea6af85b2"
S = "${WORKDIR}/h264_encoder_core-release-release-dashing-h264_encoder_core-2.0.1-1"
