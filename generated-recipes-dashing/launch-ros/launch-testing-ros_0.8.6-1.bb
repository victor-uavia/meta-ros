...
SRC_URI = "https://github.com/ros2-gbp/launch_ros-release/archive/release/dashing/launch_testing_ros/0.8.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3319debced4d1074862d7fc4fb8afb5d"
SRC_URI[sha256sum] = "e67b52ccae99649d4f16f3dddcdabf80daad88762a32289735f5c0767e870118"
S = "${WORKDIR}/launch_ros-release-release-dashing-launch_testing_ros-0.8.6-1"
