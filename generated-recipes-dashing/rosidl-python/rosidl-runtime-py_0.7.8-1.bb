...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/rosidl_runtime_py/0.7.8-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f8036be847a902e6babd705f3e7b6163"
SRC_URI[sha256sum] = "c8830596d56680fd288ccc552ddfcbe534cb0e5416800a5e8bfb4f9bb5bd4c01"
S = "${WORKDIR}/rosidl_python-release-release-dashing-rosidl_runtime_py-0.7.8-1"
