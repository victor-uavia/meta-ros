...
SRC_URI = "https://github.com/ros2-gbp/rclpy-release/archive/release/dashing/rclpy/0.7.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "62720c12cc09c214d915d3b4ed561e26"
SRC_URI[sha256sum] = "f787e1c321d393ffe82db00fec5dbf9012b087ea5ab1aa439c6bc5ee6b51df3d"
S = "${WORKDIR}/rclpy-release-release-dashing-rclpy-0.7.7-1"
