...
SRC_URI = "https://github.com/SteveMacenski/navigation2-release/archive/release/dashing/dwb_core/0.2.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7559ac3df01ea1dd9f816120a184a715"
SRC_URI[sha256sum] = "83c7038cc384caad35bdca6b2a1e43288fd7b2634c6132ef3bfce811d105aa8c"
S = "${WORKDIR}/navigation2-release-release-dashing-dwb_core-0.2.4-1"
