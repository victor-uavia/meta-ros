...
SRC_URI = "https://github.com/SteveMacenski/navigation2-release/archive/release/dashing/nav2_voxel_grid/0.2.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b7ac0d947ed4e5eb8fe69cf7ff3c189b"
SRC_URI[sha256sum] = "117025364a2f8697eaf46da64b2c589f080c0a0a48ff6fa3ce7ce8594a57fc6c"
S = "${WORKDIR}/navigation2-release-release-dashing-nav2_voxel_grid-0.2.4-1"
