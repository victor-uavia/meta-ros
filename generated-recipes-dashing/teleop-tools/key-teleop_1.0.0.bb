...
SRC_URI = "https://github.com/ros-gbp/teleop_tools-release/archive/release/dashing/key_teleop/1.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2c1a7a9207c5d499d50599f68bc1b8cd"
SRC_URI[sha256sum] = "6ee2346cc0209ea8dfdb3f39bd95d2ce93d4a305ca3693361e1bb42bd8465a38"
S = "${WORKDIR}/teleop_tools-release-release-dashing-key_teleop-1.0.0-0"
