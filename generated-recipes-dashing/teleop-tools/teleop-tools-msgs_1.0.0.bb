...
SRC_URI = "https://github.com/ros-gbp/teleop_tools-release/archive/release/dashing/teleop_tools_msgs/1.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f9912060b222dd43c54f9740be07f45d"
SRC_URI[sha256sum] = "5fc61c9120cece28af096b99bd9987223753fd1248008e42dc297aeefe9cc87b"
S = "${WORKDIR}/teleop_tools-release-release-dashing-teleop_tools_msgs-1.0.0-0"
