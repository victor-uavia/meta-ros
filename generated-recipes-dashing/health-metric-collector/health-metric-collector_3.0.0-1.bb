...
SRC_URI = "https://github.com/aws-gbp/health_metric_collector-release/archive/release/dashing/health_metric_collector/3.0.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9d8ecce7705b7b44122df67e2bf32de7"
SRC_URI[sha256sum] = "f9032183e052c43465f1a2ed6fd1e9da78ae4486e11e9f015abdf7f6e82276fa"
S = "${WORKDIR}/health_metric_collector-release-release-dashing-health_metric_collector-3.0.0-1"
