...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_pclint/0.7.9-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1c0138b7e8fee2d822608adedf0fa5cd"
SRC_URI[sha256sum] = "e4a8c77dd6212c48725d922e7fe83f07f32937d7afed6eda6b601cc607fa3acb"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_pclint-0.7.9-1"
