...
SRC_URI = "https://github.com/ros2-gbp/launch-release/archive/release/dashing/launch/0.8.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4e939ccebdaeb9fed606c08c9261e120"
SRC_URI[sha256sum] = "d072ef1fc72b59b15b8f8c020c3846a006f1a2a61968169f5f38ba4dedbd09e7"
S = "${WORKDIR}/launch-release-release-dashing-launch-0.8.6-1"
