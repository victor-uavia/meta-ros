...
SRC_URI = "https://github.com/ros2-gbp/launch-release/archive/release/dashing/launch_testing_ament_cmake/0.8.6-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1e06b2ae78c59e9820e1c8d36eb0a7ff"
SRC_URI[sha256sum] = "13185a67ba347a5432b50fb213bd980a06311dc239aa7637a0db3cd3598f2ca7"
S = "${WORKDIR}/launch-release-release-dashing-launch_testing_ament_cmake-0.8.6-1"
