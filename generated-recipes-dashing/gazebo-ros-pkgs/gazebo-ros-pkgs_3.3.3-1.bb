...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_ros_pkgs/3.3.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dca2eb6ef73fe78800c5decafc7beae9"
SRC_URI[sha256sum] = "4c6480d36d64451f1791068122eb04659a638a20af95268dcb4ca691c42f3f34"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-dashing-gazebo_ros_pkgs-3.3.3-1"
